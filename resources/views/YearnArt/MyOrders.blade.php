            ...
            <script type="module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.esm.js"></script>
                ...
                const totalItemsElement = document.getElementById('totalItems'); // Corrected ID
                const totalPricesElement = document.getElementById('totalPrices'); // Corrected ID
                ...
                function updateTotals() {
                            ...
                            // Update the total items in the footer
                            totalItemsElement.textContent = totalItems;

                            // Update the total prices in the footer
                ...
                // You might need to call updateTotals initially if some items are pre-selected
                // updateTotals();
            });
